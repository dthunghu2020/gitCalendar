...
public class ArticleAdapter extends GroupRecyclerAdapter<String, Article> {
    ...
    public ArticleAdapter(Context context) {
        ...
        map.put("Hôm nay đề nghị", create(0));
        map.put("Nóng hàng tuần", create(1));
        map.put("Nhận xét cao nhất", create(2));
        titles.add("Khuyến nghị hôm nay");
        titles.add("Nóng hàng tuần");
        titles.add("Nhận xét cao nhất");
    ...
    private static List<Article> create(int p) {
        ...
        if (p == 0) {
            list.add(create("Một trận động đất mạnh 5,7 độ xảy ra ở quần đảo Kermadek, New Zealand, với độ sâu tiêu cự 10 km",
                    "#\n" +
                            "Tin tức động đất#Mạng lưới động đất Trung Quốc chính thức xác định rằng một trận động đất mạnh 5,7 độ xảy ra ở quần đảo Kermadeke (32,82 độ vĩ nam, 178,73 độ kinh tây) vào lúc 08:08 ngày 4 tháng 12, với độ sâu 10 km.",
                    "http://cms-bucket.nosdn.127.net/catchpic/2/27/27e2ce7fd02e6c096e21b1689a8a3fe9.jpg?imageView&thumbnail=550x0"));
            list.add(create("Nga gọi những bất công là \"người đứng sau\", Nga và Hoa Kỳ rơi vào vòng xoáy \"hậu sự thật\"",
