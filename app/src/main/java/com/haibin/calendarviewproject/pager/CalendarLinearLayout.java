 ...
 *Nếu có xung đột sự kiện trong việc lồng nhiều Chế độ xem khác nhau, bạn có thể thực hiện phương pháp này
 */
public class CalendarLinearLayout extends LinearLayout implements CalendarLayout.CalendarScrollView {
     ...
     *Nếu bạn muốn làm cho danh sách thả xuống không hợp lệ
     *
